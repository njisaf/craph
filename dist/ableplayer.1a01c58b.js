...
(function ($) {
  ...
  AblePlayer.prototype.getPlayer = function () {
    ...
    } else if (this.testFallback || (this.isUserAgent('msie 7') || this.isUserAgent('msie 8') || this.isUserAgent('msie 9')) && this.mediaType === 'video' || this.isIOS() && (this.isIOS(4) || this.isIOS(5) || this.isIOS(6))) {
  ...
  AblePlayer.prototype.jwCanPlay = function () {
    ...
    if (this.$sources.length > 0) {
      // this media has one or more <source> elements
      for (i = 0; i < this.$sources.length; i++) {
        sourceType = this.$sources[i].getAttribute('type');
        if (this.mediaType === 'video' && sourceType === 'video/mp4' || this.mediaType === 'audio' && sourceType === 'audio/mpeg') {
...
(function ($) {
    ...
    for (i = 0; i < available.length; i++) {
      ...
      if (available[i]['group'] == form && available[i]['label']) {
        ...
        if (thisPref == 'prefDescFormat') {
          ...
          $div1 = $('<div>');
          id1 = thisId + '_1';
          $label1 = $('<label>').attr('for', id1).text(this.capitalizeFirstLetter(this.tt.prefDescFormatOption1));
          $radio1 = $('<input>', {
            type: 'radio',
            name: thisPref,
            id: id1,
          ...
          $div2 = $('<div>');
          id2 = thisId + '_2';
          $label2 = $('<label>').attr('for', id2).text(this.capitalizeFirstLetter(this.tt.prefDescFormatOption2));
          $radio2 = $('<input>', {
            type: 'radio',
            name: thisPref,
            id: id2,
  ...
  AblePlayer.prototype.savePrefsFromForm = function () {
    ...
    if (this.player === 'youtube' && typeof this.usingYouTubeCaptions !== 'undefined' && this.usingYouTubeCaptions && capSizeChanged) {
...
(function ($) {
  ...
  function parseCue(state) {
    ...
    var cueTimings = actList(state, [getTiming, eatAtLeast1SpacesOrTabs, eatArrow, eatAtLeast1SpacesOrTabs, getTiming]);
...
(function ($) {
  ...
  AblePlayer.prototype.getOptimumPosition = function (targetWindow, targetWidth) {
    ...
    var gap, position, ableWidth, ableHeight, ableOffset, ableTop, ableLeft, windowWidth, otherWindowWidth, zIndex;
  ...
  AblePlayer.prototype.createPopup = function (which) {
    ...
    var thisObj, $popup, $thisButton, $thisListItem, $prevButton, $nextButton, selectedTrackIndex, selectedTrack;
    thisObj = this;
    $popup = $('<div>', {
  ...
  AblePlayer.prototype.setupPopups = function (which) {
    ...
    var popups, thisObj, hasDefault, i, j, tracks, trackList, trackItem, track, radioName, radioId, trackButton, trackLabel, prefCats, prefCat, prefLabel;
    ...
    if (which === 'captions' || typeof which === 'undefined') {
      if (typeof this.ytCaptions !== 'undefined') {
        // setup popup for YouTube captions
        if (this.ytCaptions.length) {
          popups.push('ytCaptions');
        }
      } else {
        // setup popup for local captions
        ...
        if (popup === 'prefs') {
          ...
          for (j in tracks) {
            ...
            if (popup == 'captions' || popup == 'ytCaptions') {
              ...
              var getClickFunction = function getClickFunction(time) {
                return function () {
                  thisObj.seekTo(time);
  ...
  AblePlayer.prototype.provideFallback = function (reason) {
    ...
    var $fallbackDiv, width, mediaClone, fallback, fallbackText, showBrowserList, browsers, i, b, browserList;
  ...
  AblePlayer.prototype.addControls = function () {
    ...
    var useSpeedButtons, useFullScreen, i, j, k, controls, $controllerSpan, tooltipId, tooltipX, tooltipY, control, buttonImg, buttonImgSrc, buttonTitle, newButton, iconClass, buttonIcon, buttonUse, leftWidth, rightWidth, totalWidth, leftWidthStyle, rightWidthStyle, controllerStyles, vidcapStyles, captionLabel, popupMenuId;
  ...
  AblePlayer.prototype.useSvg = function () {
    ...
    checkUseElems = function checkUseElems() {
      var base,
          bcr,
          fallback = '',
          // optional fallback URL in case no base path to SVG file was given and no symbol definition was found.
      hash,
          i,
          Request,
          inProgressCount = 0,
  ...
  AblePlayer.prototype.finalizeYoutubeInit = function () {
    ...
    this.youTubePlayer = new YT.Player(containerId, {
      ...
      events: {
        ...
        onStateChange: function onStateChange(x) {
        ...
        onApiChange: function onApiChange(x) {
...
(function ($) {
  AblePlayer.prototype.initDescription = function () {
    ...
    if (this.prefDesc) {
      ...
      if (this.refreshingDesc) {
        // user just now toggled it off
        this.prevDescFormat = this.useDescFormat;
        this.useDescFormat = false;
        this.descOn = false;
      } else {
        // desc has always been off
        this.useDescFormat = false;
      }
    }
    ...
    if (this.descOn) {
      ...
      if (this.useDescFormat === 'video') {
        ...
        if (this.prefVisibleDesc) {
          ...
          // keep it visible to screen readers, but hide from everyone else
  ...
  AblePlayer.prototype.showDescription = function (now) {
    ...
    var flattenComponentForDescription = function flattenComponentForDescription(component) {
      var result = [];
...
(function ($) {
  ...
  AblePlayer.prototype.refreshControls = function () {
    ...
    var thisObj, duration, elapsed, lastChapterIndex, displayElapsed, updateLive, textByState, timestamp, widthUsed, leftControls, rightControls, seekbarWidth, seekbarSpacer, captionsCount, buffered, newTop, svgLink, newSvgLink, statusBarHeight, speedHeight, statusBarWidthBreakpoint;
    ...
    if (this.transcriptType) {
      ...
      if (this.autoScrollTranscript && this.currentHighlight) {
        newTop = Math.floor($('.able-transcript').scrollTop() + $(this.currentHighlight).position().top - $('.able-transcript').height() / 2 + $(this.currentHighlight).height() / 2);
  ...
  AblePlayer.prototype.isFullscreen = function () {
    if (this.nativeFullscreenSupported()) {
      return document.fullscreenElement || document.webkitFullscreenElement || document.webkitCurrentFullScreenElement || document.mozFullScreenElement || document.msFullscreenElement ? true : false;
    } else {
  ...
  AblePlayer.prototype.setFullscreen = function (fullscreen) {
    ...
    if (this.nativeFullscreenSupported()) {
      ...
      if (!this.fullscreenDialog) {
        ...
        this.fullscreenDialog = new AccessibleDialog($dialogDiv, this.$fullscreenButton, 'dialog', 'Fullscreen video player', $fsDialogAlert, this.tt.exitFullScreen, '100%', true, function () {
...
(function ($) {
  ...
  AblePlayer.prototype.flattenCueForCaption = function (cue) {
    ...
    var flattenComponent = function flattenComponent(component) {
      var result = [];
      if (component.type === 'string') {
        result.push(component.value);
...
(function ($) {
  ...
  AblePlayer.prototype.updateChaptersList = function () {
    ...
    var thisObj, cues, $chaptersList, c, thisChapter, $chapterItem, $chapterButton, buttonId, hasDefault, getClickFunction, $clickedItem, $chaptersList, thisChapterIndex;
    ...
    if (cues.length > 0) {
      ...
      for (c in cues) {
        ...
        // add event listeners
        getClickFunction = function getClickFunction(time) {
          return function () {
      ...
      if (!hasDefault) {
        ...
        $chaptersList.find('button').first().attr('aria-selected', 'true').parent('li').addClass('able-current-chapter');
      }
    ...
    if (typeof thisChapterIndex !== 'undefined') {
      if (this.currentChapter !== chapters[thisChapterIndex]) {
        ...
        if (typeof this.$chaptersDiv !== 'undefined') {
          ...
          this.$chaptersDiv.find('ul').find('li').eq(thisChapterIndex).addClass('able-current-chapter').attr('aria-selected', 'true');
        }
...
(function ($) {
  ...
  AblePlayer.prototype.generateTranscript = function (chapters, captions, descriptions) {
    ...
    var addChapter = function addChapter(div, chap) {
      ...
      var flattenComponentForChapter = function flattenComponentForChapter(comp) {
    ...
    var addDescription = function addDescription(div, desc) {
      var $descDiv = $('<div>', {
      ...
      var flattenComponentForDescription = function flattenComponentForDescription(comp) {
    ...
    var addCaption = function addCaption(div, cap) {

      var $capSpan = $('<span>', {
        'class': 'able-transcript-seekpoint able-transcript-caption'
      });

      var flattenComponentForCaption = function flattenComponentForCaption(comp) {
...
(function ($) {
  ...
  AblePlayer.prototype.onMediaUpdateTime = function () {
    ...
    if (this.swappingSrc && typeof this.swapTime !== 'undefined') {
      ...
      // not swapping src, not started playing, not seeking
      if (this.autoplay) {
        this.playMedia();
      }
    }
...
(function ($) {
  ...
  AblePlayer.prototype.addWindowMenu = function (which, $window, windowName) {
    ...
    var thisObj, $windowAlert, $newButton, $buttonIcon, buttonImgSrc, $buttonImg, $buttonLabel, tooltipId, $tooltip, $popup, label, position, buttonHeight, buttonWidth, tooltipY, tooltipX, tooltipStyle, tooltip, $optionList, radioName, options, i, $optionItem, option, radioId, $radioButton, $radioLabel;
  ...
  AblePlayer.prototype.addResizeDialog = function (which, $window) {
    ...
    var thisObj, $windowPopup, $windowButton, widthId, heightId, startingWidth, startingHeight, aspectRatio, $resizeForm, $resizeWrapper, $resizeWidthDiv, $resizeWidthInput, $resizeWidthLabel, $resizeHeightDiv, $resizeHeightInput, $resizeHeightLabel, tempWidth, tempHeight, $saveButton, $cancelButton, newWidth, newHeight, resizeDialog;
...
//# sourceMappingURL=/ableplayer.1a01c58b.map