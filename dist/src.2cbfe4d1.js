...
},{"object-assign":51,"fbjs/lib/emptyObject":52,"fbjs/lib/emptyFunction":53}],54:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./emptyFunction":53}],62:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"fbjs/lib/invariant":54,"fbjs/lib/warning":55,"./lib/ReactPropTypesSecret":62}],13:[function(require,module,exports) {
/** @license React v16.3.1
...
},{"object-assign":51,"fbjs/lib/emptyObject":52,"fbjs/lib/invariant":54,"fbjs/lib/warning":55,"fbjs/lib/emptyFunction":53,"prop-types/checkPropTypes":43}],6:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react.production.min.js":12,"./cjs/react.development.js":13}],56:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./isNode":71}],59:[function(require,module,exports) {
'use strict';
...
},{"./isTextNode":65}],14:[function(require,module,exports) {
/** @license React v16.3.1
...
},{"react":6,"fbjs/lib/ExecutionEnvironment":56,"object-assign":51,"fbjs/lib/emptyFunction":53,"fbjs/lib/getActiveElement":57,"fbjs/lib/shallowEqual":58,"fbjs/lib/containsNode":59,"fbjs/lib/emptyObject":52}],68:[function(require,module,exports) {
'use strict';
...
},{"./camelize":67}],15:[function(require,module,exports) {
/** @license React v16.3.1
...
},{"react":6,"fbjs/lib/invariant":54,"fbjs/lib/warning":55,"fbjs/lib/ExecutionEnvironment":56,"object-assign":51,"fbjs/lib/emptyFunction":53,"prop-types/checkPropTypes":43,"fbjs/lib/getActiveElement":57,"fbjs/lib/shallowEqual":58,"fbjs/lib/containsNode":59,"fbjs/lib/emptyObject":52,"fbjs/lib/hyphenateStyleName":61,"fbjs/lib/camelizeStyleName":60}],7:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react-dom.production.min.js":14,"./cjs/react-dom.development.js":15}],44:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"fbjs/lib/emptyFunction":53,"fbjs/lib/invariant":54,"fbjs/lib/warning":55,"object-assign":51,"./lib/ReactPropTypesSecret":62,"./checkPropTypes":43}],45:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"fbjs/lib/emptyFunction":53,"fbjs/lib/invariant":54,"./lib/ReactPropTypesSecret":62}],24:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./factoryWithTypeCheckers":44,"./factoryWithThrowingShims":45}],37:[function(require,module,exports) {
'use strict';
...
},{"react":6,"prop-types":24}],9:[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.Provider = exports.Subscribe = exports.Container = undefined;
...
var StateContext = (0, _createReactContext2.default)(null);
...
var Subscribe = function (_React$Component) {
  ...
  Subscribe.prototype.render = function render() {
    ...
    return _react2.default.createElement(StateContext.Consumer, null, function (map) {
...
Subscribe.propTypes = {
  to: _propTypes2.default.array.isRequired,
  children: _propTypes2.default.func.isRequired
};

function Provider(props) {
  return _react2.default.createElement(StateContext.Consumer, null, function (parentMap) {
    ...
    return _react2.default.createElement(StateContext.Provider, { value: childMap }, props.children);
  });
}
...
},{"react":6,"create-react-context":37,"prop-types":24}],23:[function(require,module,exports) {
'use strict';
...
var MediaContainer = function (_Container) {
  _inherits(MediaContainer, _Container);
  ...
  function MediaContainer() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MediaContainer.__proto__ || Object.getPrototypeOf(MediaContainer)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      playing: false,
      time: 0
    }, _this.playMedia = function () {
      _this.setState({
        playing: true
      });
    }, _this.pauseMedia = function () {
      _this.setState({
        playing: false
      });
    }, _temp), _possibleConstructorReturn(_this, _ret);
...
},{"unstated":9}],18:[function(require,module,exports) {
"use strict";
...
var OffScreen = function (_React$Component) {
  _inherits(OffScreen, _React$Component);
  ...
  _createClass(OffScreen, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        "div",
        { className: "reactAblePlayer__offscreen" },
...
var Media = (_temp = _class = function (_React$Component) {
  ...
  function Media(props) {
    ...
    _this.video = null;
    _this.state = _this.props.mediaState;
    return _this;
  }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        { ref: function ref(el) {
          ...
          }, id: this.props.id, tabIndex: '-1', poster: this.props.poster, style: { width: '100%', height: 'auto' } },
        _react2.default.createElement('source', { type: 'video/webm', src: this.props.source }),
        _react2.default.createElement('track', { kind: 'captions', src: this.props.captions })
      );
    }
  }], [{
  ...
  mediaState: _propTypes2.default.object.isRequired,
  source: _propTypes2.default.string,
  captions: _propTypes2.default.string,
  poster: _propTypes2.default.string
}, _temp);
exports.default = Media;
},{"react":6,"prop-types":24}],19:[function(require,module,exports) {
"use strict";
...
var Captions = function (_React$Component) {
  ...
  function Captions() {
    ...
    return _possibleConstructorReturn(this, (Captions.__proto__ || Object.getPrototypeOf(Captions)).apply(this, arguments));
  }
  ...
  _createClass(Captions, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        "div",
        { className: "reactAblePlayer__captions" },
...
},{"react":6}],46:[function(require,module,exports) {
'use strict';
...
var ControlButton = (_temp2 = _class = function (_React$Component) {
  ...
  function ControlButton() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ControlButton.__proto__ || Object.getPrototypeOf(ControlButton)).call.apply(_ref, [this].concat(args))), _this), _this.handleOnClick = function (e) {
      e.preventDefault();
      if (_this.props.onClick) {
        _this.props.onClick(_this.props.buttonName);
      }
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(ControlButton, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'button',
        { type: 'button', onClick: this.handleOnClick, tabIndex: '0', 'aria-label': this.props.buttonName, className: this.props.className },
...
},{"react":6,"prop-types":24}],22:[function(require,module,exports) {
'use strict';
...
var _media = require('../../containers/media.container');
...
var Controls = function (_React$Component) {
  ...
  _createClass(Controls, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'ablePlayer__controls' },
        _react2.default.createElement(
          'div',
          { className: 'able-controller able-white-controls' },
          _react2.default.createElement(
            _unstated.Subscribe,
            { to: [_media2.default] },
            function (media) {
              return _react2.default.createElement(
                ...
                _react2.default.createElement(_ControlButton2.default, {
                  ...
                  onClick: function onClick() {
                    ...
                    media.state.playing ? media.pauseMedia() : media.playMedia();
                  } })
              );
            }
          )
...
},{"react":6,"unstated":9,"../../containers/media.container":23,"./ControlButton":46}],21:[function(require,module,exports) {
"use strict";
...
},{"react":6}],66:[function(require,module,exports) {
var bundleURL = null;
...
},{"./../fonts/able.eot":[["able.ed53f7e9.eot",39],39],"./../fonts/able.ttf":[["able.f03d3c26.ttf",40],40],"./../fonts/able.woff":[["able.7349e3ea.woff",41],41],"./../fonts/able.svg":[["able.5bc673de.svg",42],42],"_css_loader":38}],5:[function(require,module,exports) {
'use strict';
...
var _OffScreen = require('../components/OffScreen');
...
var _Captions = require('../components/Captions');
...
var AblePlayer = (_temp = _class = function (_React$Component) {
  _inherits(AblePlayer, _React$Component);

  function AblePlayer() {
    _classCallCheck(this, AblePlayer);

    return _possibleConstructorReturn(this, (AblePlayer.__proto__ || Object.getPrototypeOf(AblePlayer)).apply(this, arguments));
  }

  _createClass(AblePlayer, [{
    key: 'render',
    value: function render() {
      var _this2 = this;
      ...
      return _react2.default.createElement(
        'div',
        { id: this.props.id, className: 'reactAblePlayer' },
        _react2.default.createElement(_OffScreen2.default, null),
        _react2.default.createElement(
          _unstated.Subscribe,
          { to: [_media2.default] },
          function (media) {
            return _react2.default.createElement(_Media2.default, {
              ref: function ref(_ref) {
                return _this2.mediaRef = _ref;
              },
              mediaState: media.state,
              id: _this2.props.id,
              source: _this2.props.source,
              poster: _this2.props.poster });
          }
        ),
        _react2.default.createElement(_Captions2.default, { captions: this.props.captions }),
...
exports.default = AblePlayer;
},{"react":6,"prop-types":24,"unstated":9,"../containers/media.container":23,"../components/OffScreen":18,"../components/Media":20,"../components/Captions":19,"../components/Controls/Controls":22,"../components/StatusBar":21,"../../styles/main.scss":11}],25:[function(require,module,exports) {
/* ========================================================================
...
module.exports = {
  "type": "VIDEO",
  "id": "video1",
  "source": "https://www.paypalobjects.com/webstatic/mktg/videos/PayPal_AustinSMB_baseline.webm",
  "title": "Do we need a title?",
  "description": "Well why not throw a description in.",
  "poster": "https://paypal.github.io/accessible-html5-video-player/media/poster_PayPal_Austin2.jpg",
  "posterAltText": "Here is some alt text.",
  "lengthInSeconds": 428,
  "caption": "https://paypal.github.io/accessible-html5-video-player/media/captions_PayPal_Austin_en.vtt"
}
;
...
var _AblePlayer = require('./scripts/AblePlayer');

var _AblePlayer2 = _interopRequireDefault(_AblePlayer);

require('bootstrap');

var _MockData = require('../content/MockData.json');
...
// bootstrap is required for modals
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_AblePlayer2.default, {
          id: _MockData2.default.id,
          source: _MockData2.default.source,
          poster: _MockData2.default.poster,
          captions: _MockData2.default.caption
        })
      );
    }
  }]);
...
//   });
// }
},{"react":6,"react-dom":7,"unstated":9,"./scripts/AblePlayer":5,"bootstrap":10,"../content/MockData.json":4}],72:[function(require,module,exports) {
...
//# sourceMappingURL=/src.2cbfe4d1.map